...
function(compile_proto_to_cpp PROTO_LIBRARY_NAME PB_H PB_CC PROTO)
  ...
  string(REGEX REPLACE "/[^/]*$" "" PROTO_ABS_DIR ${PROTO_ABS})
  # get relative (to LIBP2P_SRC_ROOT) path of current proto file
  file(RELATIVE_PATH SCHEMA_REL "${LIBP2P_SRC_ROOT}" "${PROTO_ABS_DIR}")
  ...
  add_custom_command(
      ...
      COMMAND ${GEN_COMMAND}
      ARGS -I${LIBP2P_SRC_ROOT} -I${GEN_ARGS} --cpp_out=${SCHEMA_OUT_DIR} ${PROTO_ABS}
