...
namespace eosio { namespace vm {
   ...
   inline static thread_local std::atomic<sigjmp_buf*> signal_dest = ATOMIC_VAR_INIT(nullptr);
   inline static thread_local std::exception_ptr saved_exception = nullptr;
   template<int Sig>
