...
if(Event_INCLUDE_DIR)
	...
	if(WIN32)
		set(_EX__LIBRARIES "$<$<PLATFORM_ID:Windows>:ws2_32;shell32;advapi32>" )
	endif()
	...
	find_component(Event event
		...
		INTERFACE_LINK_LIBRARIES "${_EX__LIBRARIES}"
	)
	...
	if(NOT Event_VERSION)
		...
		elseif(NOT CMAKE_CROSSCOMPILING)
			try_run(_Event_CheckVersion_RESULT _Event_CheckVersion_BUILD
				"${CMAKE_BINARY_DIR}"
				"${CMAKE_SOURCE_DIR}/CMakeModules/helper/EventCheckVersion.cpp"
